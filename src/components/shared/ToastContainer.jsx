...
const TOAST_STYLES = {
  ...
  error: 'bg-joy-100 text-joy-800 border-joy-300',
...
export default function ToastContainer() {
  ...
  return (
    <div className="fixed bottom-4 left-3 right-3 sm:left-auto sm:right-4 z-[9999] flex flex-col gap-2 sm:max-w-sm">
      {toasts.map((t) => (
